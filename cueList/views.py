...
#Delete CueList - deletes given cue list (designated by parent of delete button)
@login_required
def cueListDeleteDashboard(request, cueListID):
...
class CueListCreateView(CreateView):
